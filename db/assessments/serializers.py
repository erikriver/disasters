...
from .models import Site, Assessment
import json
...
class AssessmentTypeSerializer(ModelSerializer):
...
class ChildAssessmentSerializer(ModelSerializer):
    class Meta:
        model = Assessment
        fields = "__all__"
...
class AssessmentSerializer(ModelSerializer):
    childassessment = ChildAssessmentSerializer(many=True, read_only=True)   # try also adding (Required=False) to args?
    ...
    def to_internal_value(self, data):
        ...
        # On-the-fly site creation (New Site + Assessment)
