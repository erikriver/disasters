"""
Django settings for disasters project.
...
ALLOWED_HOSTS = ["desastres.rivera.pro", "127.0.0.1"]
...
WSGI_APPLICATION = 'disasters.wsgi.application'
...
ADMINS=[('Erik Rivera', 'erik@rivera.pro'),]
